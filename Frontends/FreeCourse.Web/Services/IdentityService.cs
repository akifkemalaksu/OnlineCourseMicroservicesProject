...
namespace FreeCourse.Web.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<TokenResponse> GetAccessTokenByRefreshToken()
        {
            ...
            await _httpContextAccessor.HttpContext.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme, authenticationResult.Principal);
        ...
        public async Task<Response<bool>> SignIn(SignInInput signInInput)
        {
            ...
            if (token.IsError)
            {
                ...
                return Response<bool>.Fail(errorDto.Errors, HttpStatusCode.BadRequest);
            }
